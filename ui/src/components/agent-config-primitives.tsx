...
export const help: Record<string, string> = {
  ...
  heartbeatAdapterType: "Use a different adapter for heartbeat runs. Leave empty to use the agent's primary adapter. Set to 'manifest' to route heartbeats through the Manifest LLM router, or 'manifest_triage' for triage + Manifest.",
